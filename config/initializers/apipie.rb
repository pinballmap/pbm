Apipie.configure do |config|
  ...
  config.app_info = "
    ...
    API use requires a key, which can be requested here: https://pinballmap.com/api_token<br><br>
    Keep your key server-side only. Never embed it in browser JavaScript or other client-side code end users can inspect. If your app has a JS frontend, proxy requests through your own backend.<br><br>
