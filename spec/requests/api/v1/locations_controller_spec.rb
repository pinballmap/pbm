...
describe Api::V1::LocationsController, type: :request do
  ...
  describe '#within_bounding_box' do
    it 'sends you locations within the transmitted bounding box, along with machines at the locations' do
      ...
      get '/api/v1/locations/within_bounding_box.json', params: { swlat: 45.478363717877436, swlon: -122.64672405963799, nelat: 45.54521396088108, nelon: -122.56878059990427, 'by_machine_id[]' => [ machine_two.id, machine_three.id ] }
    ...
    it 'includes a distance field when order_by=distance and user_lat and user_lon and limit and no_details=1 are present' do
      location_01 = FactoryBot.create(:location, name: 'A_Location', id: 6000, lat: 45.526112069408704, lon: -122.60884314086321)
      location_02 = FactoryBot.create(:location, name: 'B_Location', id: 7000, lat: 45.53007190362438, lon: -122.60795065851514)

      get '/api/v1/locations/within_bounding_box.json', params: { swlat: 45.478363717877436, swlon: -122.64672405963799, nelat: 45.54521396088108, nelon: -122.56878059990427, order_by: 'distance', limit: 2, user_lat: 45.526112069408704, user_lon: -122.60884314086321, no_details: 1 }
  ...
  describe '#machine_details' do
    ...
    it 'displays details of machines at location' do
      FactoryBot.create(:location_machine_xref, location: @location, machine: FactoryBot.create(:machine, id: 123, name: 'Cleo', year: 1980, manufacturer: 'Stern', ipdb_id: nil))
      FactoryBot.create(:location_machine_xref, location: @location, machine: FactoryBot.create(:machine, id: 456, name: 'Sass', year: 1960, manufacturer: 'Bally', ipdb_id: 123))
      FactoryBot.create(:location_machine_xref, deleted_at: Time.current, location: @location, machine: FactoryBot.create(:machine, id: 234, name: 'Deleted Pro', year: 1960, manufacturer: 'Bally', ipdb_id: 234))
