...
describe SuggestedLocationsController, type: :controller do
  before(:each) do
    ...
    @sl = FactoryGirl.create(:suggested_location, name: 'name', street: 'street', city: 'city', state: 'OR', zip: '97203', phone: '555-555-5555', lat: 11.11, lon: 22.22, website: 'http://www.cool.com', region: @r, location_type: @lt, operator: @o, machines: 'The Dark Knight (Stern, 2008), Star Trek (Pro) (Stern, 2013), Challenger [Gottlieb - 1971], this will not match')
  end
  ...
  describe '#convert_to_location' do
    it 'should create a corresponding location, delete itself, redirect to admin page' do
      ...
      m_three = FactoryGirl.create(:machine, name: 'Star Trek (Pro)', manufacturer: 'Stern', year: '2013')
      ...
      (lmx_one, lmx_two, lmx_three) = LocationMachineXref.all
