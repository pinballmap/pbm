...
#  end
  ...
  describe '#content_for_infowindow' do
    it 'generate the html that the infowindow wants to use' do
      ...
      expect(l.content_for_infowindow.chomp).to eq("'<div class=\"infowindow\"><div class=\"gm_location_name\">Test Location Name</div><div class=\"gm_address\">303 Southeast 3rd Avenue<br />Portland, OR, 97214<br /></div><hr /><div class=\"gm_machines\">Bar<br />Baz<br />Beans\\'<br />Foo<br /></div></div>'")
    end
  end
