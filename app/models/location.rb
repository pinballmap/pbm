class Location < ApplicationRecord
  ...
  def confirm(user)
    ...
    UserSubmission.create(region_id: region&.id, location: self, submission_type: UserSubmission::CONFIRM_LOCATION_TYPE, submission: "#{user ? user.username : 'UNKNOWN'} confirmed the lineup at #{name} (#{city})", user: user)
