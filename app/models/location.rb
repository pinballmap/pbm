class Location < ApplicationRecord
  ...
  def last_updated_by_user_deleted
    last_updated_by_user_id.present? && last_updated_by_user.blank?
  end
  ...
  def confirm(user)
    ...
    if recent_confirm.blank? ||
       (recent_add_remove.present? && recent_confirm < recent_add_remove) ||
       recent_confirm < 7.days.ago.beginning_of_day
