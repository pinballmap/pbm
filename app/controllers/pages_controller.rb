class PagesController < ApplicationController
  ...
  def stats
    @top_25 = Rails.cache.fetch("top_25_cache", expires_in: 1.hour) do
...
limit 25")
    ...
    @user_submissions_all = Rails.cache.fetch("user_submissions_all_cache", expires_in: 1.hour) do
    ...
    Rails.cache.fetch("user_submissions_week_cache", expires_in: 1.hour) do
    ...
    @top_users =
    Rails.cache.fetch("top_users_cache", expires_in: 1.hour) do
    ...
    Rails.cache.fetch("machine_adds_this_year_cache", expires_in: 1.hour) do
    ...
    Rails.cache.fetch("machine_adds_last_year_cache", expires_in: 1.hour) do
