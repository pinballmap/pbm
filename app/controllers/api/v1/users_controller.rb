    ...
    class UsersController < InheritedResources::Base
      ...
      def profile_info
        ...
        return_response(
          ...
          'profile_info',
          [],
          %i[contributor_rank contributor_rank_int num_total_submissions num_machines_added num_machines_removed num_locations_edited num_locations_suggested num_lmx_comments_left num_msx_scores_added profile_list_of_edited_locations profile_list_of_high_scores created_at]
        )
      rescue ActiveRecord::RecordNotFound
