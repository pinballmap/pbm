class MapsController < ApplicationController
  ...
  has_scope :by_location_name, :by_location_id, :by_machine_id, :by_machine_single_id, :by_at_least_n_machines, :by_type_id, :by_operator_id, :user_faved, :by_city_name, :by_state_name, :by_city_no_state, :by_country, :by_machine_type, :by_machine_display, :manufacturer, type: :array
