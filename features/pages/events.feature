Feature: events for region
  ...
  Scenario: basic event displaying
    ...
    And the following events exist:
      |region_id|name|start_date|location_id|external_location_name|
      |1|event 1|2011-01-20|1||
      |1|event 2|2011-01-30|1||
      |1|event 3|2011-01-10|1||
      |1|event 4||1||
      |1|event 5||1|external location name|
      |1|event 6|||external location name|
    And I am on "portland"'s events page
    Then I should see "event 6 @ external location name"
    And I should see "event 5 @ Test Location Name"
    And I should see "event 4 @ Test Location Name 2011-01-10"
