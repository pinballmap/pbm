Feature: New Machine for Location
  ...
  Scenario: Add machine by id
    Given there is a location_machine_xref
  ...
  @javascript
  Scenario: Machine dropdown displays year/manufacturer where appropriate
  ...
  @javascript
  Scenario: Add machine by name, no machines initially at location
    Given there is a location_machine_xref
    And I am on "Portland"'s home page
    And I press the "location" search button
    And I click on the add machine link for "Test Location Name"
